from app.database.event import EventPostSchema, EventPostResponseSchema, EventPostSchemaUpdated
from fastapi import APIRouter
from app.database.event.event_schema import EventGetAllSchema
...
class EventApi:
    ...
    def __get_routes(self):
        ...
        def update_event(id:int)->EventPostResponseSchema:
            return self.__service.event.update_event(id)
